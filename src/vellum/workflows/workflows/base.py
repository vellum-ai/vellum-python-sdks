...
class BaseWorkflow(Generic[InputsType, StateType], metaclass=_BaseWorkflowMeta):
    ...
    @staticmethod
    def _unique_from_subgraphs(subgraphs: Iterable[Graph], attr: str) -> Iterator[Any]:
        seen = set()
        for subgraph in subgraphs:
            for item in getattr(subgraph, attr):
                if item not in seen:
                    seen.add(item)
                    yield item
    ...
    def get_edges(cls) -> Iterator[Edge]:
        ...
        """
        return cls._unique_from_subgraphs(cls.get_subgraphs(), "edges")
    ...
    def get_nodes(cls) -> Iterator[Type[BaseNode]]:
        ...
        """
        return cls._unique_from_subgraphs(cls.get_subgraphs(), "nodes")
    ...
    def get_unused_nodes(cls) -> Iterator[Type[BaseNode]]:
        ...
        """
        return cls._unique_from_subgraphs(cls.get_unused_subgraphs(), "nodes")
    ...
    def get_unused_edges(cls) -> Iterator[Edge]:
        ...
        """
        return cls._unique_from_subgraphs(cls.get_unused_subgraphs(), "edges")
