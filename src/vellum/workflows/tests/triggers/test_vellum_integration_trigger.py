...
class TestVellumIntegrationTrigger:
    ...
    def test_factory_creates_trigger_class(self) -> None:
        ...
        assert SlackNewMessage.attributes == {}

    def test_factory_with_attributes(self) -> None:
        """Factory method creates trigger with filter attributes."""
        SlackNewMessage = VellumIntegrationTrigger.for_trigger(
            integration_name="SLACK",
            slug="slack_new_message",
            trigger_nano_id="test_nano_123",
    ...
    def test_trigger_attribute_id_stability(self) -> None:
    ...
    def test_to_exec_config_base_class_fails(self) -> None:
    ...
    def test_attribute_name_does_not_conflict_with_class_variables(self) -> None:
