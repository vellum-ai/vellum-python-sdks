...
class ToolPromptNode(InlinePromptNode[ToolCallingState]):
    ...
    def _handle_api_error(self, e):
        """
        Override the base _handle_api_error to convert INVALID_INPUTS errors to INTERNAL_ERROR.

        When the underlying prompt node returns a 400 error in the context of ToolCallingNode,
        it's typically an internal issue (e.g., malformed function call arguments generated by the LLM)
