...
from typing import Annotated, Any, Iterator, List, Optional, cast
            ...
            ChatMessagePromptBlock(
                ...
                blocks=[
                    RichTextPromptBlock(
                        ...
                        blocks=[
                            PlainTextPromptBlock(block_type="PLAIN_TEXT", text="Process this query"),
                        ],
                    ),
                ],
            ),
    ...
    def generate_prompt_events(*_args, **_kwargs) -> Iterator[ExecutePromptEvent]:
        ...
        events: List[ExecutePromptEvent] = [
            ...
            FulfilledExecutePromptEvent(
                execution_id=execution_id,
                outputs=expected_outputs,
                chat_message_metadata=thought_signature_metadata if call_count == 1 else None,
            ),
        ]
        yield from events
