...
class TestVellumIntegrationNode:
    ...
    def test_successful_tool_execution(self):
        ...
        with patch(
            ...
            mock_service.execute_tool.return_value = {"issue_id": 123, "url": "https://github.com/test/test/issues/123"}
            ...
            mock_service.execute_tool.assert_called_once_with(
                provider=VellumIntegrationProviderType.COMPOSIO,
                integration="GITHUB",
    ...
    def test_tool_execution_with_error(self):
        ...
        with patch(
            ...
            mock_service = MagicMock()
            mock_service.execute_tool.side_effect = Exception("API rate limit exceeded")
            mock_service_class.return_value = mock_service
    ...
    def test_extract_function_arguments_with_no_arguments(self):
        ...
        with patch(
            ...
            mock_service = MagicMock()
            mock_service.execute_tool.return_value = {"repos": []}
            mock_service_class.return_value = mock_service
    ...
    def test_vellum_integration_node_with_multiple_outputs(self):
        ...
        with patch(
            ...
            mock_service = MagicMock()
            mock_service.execute_tool.return_value = {"issue_key": "TEST-123"}
            mock_service_class.return_value = mock_service
