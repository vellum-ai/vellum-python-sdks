...
class AsyncFolderEntitiesClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            await client.folder_entities.list(parent_folder_id='parent_folder_id', )
        asyncio.run(main())
        """
    ...
    async def add_entity_to_folder(
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.folder_entities.add_entity_to_folder(folder_id='folder_id', entity_id='entity_id', )
        asyncio.run(main())
        """
