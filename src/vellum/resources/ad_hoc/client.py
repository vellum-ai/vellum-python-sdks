...
class AsyncAdHocClient:
    ...
    async def adhoc_execute_prompt(
        ...
        *,
        ...
        async def main() -> None:
            await client.ad_hoc.adhoc_execute_prompt(ml_model='ml_model', input_values=[PromptRequestStringInput(key='key', value='value', )], input_variables=[VellumVariable(id='id', key='key', type="STRING", )], parameters=PromptParameters(), blocks=[JinjaPromptBlock(template='template', )], )
        asyncio.run(main())
        """
    ...
    async def adhoc_execute_prompt_stream(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            response = await client.ad_hoc.adhoc_execute_prompt_stream(ml_model='ml_model', input_values=[PromptRequestStringInput(key='key', value='value', )], input_variables=[VellumVariable(id='id', key='key', type="STRING", )], parameters=PromptParameters(), blocks=[JinjaPromptBlock(template='template', )], )
