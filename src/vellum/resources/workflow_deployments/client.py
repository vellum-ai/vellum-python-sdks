...
class AsyncWorkflowDeploymentsClient:
    ...
    async def retrieve(
        ...
        client = AsyncVellum(api_version="YOUR_API_VERSION", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.workflow_deployments.retrieve(id='id', )
        asyncio.run(main())
        """
    ...
    async def list_workflow_deployment_event_executions(
        ...
        *,
        ...
        client = AsyncVellum(api_version="YOUR_API_VERSION", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.workflow_deployments.list_workflow_deployment_event_executions(id='id', )
        asyncio.run(main())
        """
    ...
    async def workflow_deployment_event_execution(
        ...
        client = AsyncVellum(api_version="YOUR_API_VERSION", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.workflow_deployments.workflow_deployment_event_execution(execution_id='execution_id', id='id', )
        asyncio.run(main())
        """
    ...
    async def workflow_deployment_history_item_retrieve(
        ...
        client = AsyncVellum(api_version="YOUR_API_VERSION", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.workflow_deployments.workflow_deployment_history_item_retrieve(history_id_or_release_tag='history_id_or_release_tag', id='id', )
        asyncio.run(main())
        """
    ...
    async def list_workflow_release_tags(
        ...
        *,
        ...
        client = AsyncVellum(api_version="YOUR_API_VERSION", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.workflow_deployments.list_workflow_release_tags(id='id', )
        asyncio.run(main())
        """
    ...
    async def retrieve_workflow_release_tag(
        ...
        client = AsyncVellum(api_version="YOUR_API_VERSION", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.workflow_deployments.retrieve_workflow_release_tag(id='id', name='name', )
        asyncio.run(main())
        """
    ...
    async def update_workflow_release_tag(
        ...
        *,
        ...
        client = AsyncVellum(api_version="YOUR_API_VERSION", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.workflow_deployments.update_workflow_release_tag(id='id', name='name', )
        asyncio.run(main())
        """
    ...
    async def retrieve_workflow_deployment_release(
        ...
        client = AsyncVellum(api_version="YOUR_API_VERSION", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.workflow_deployments.retrieve_workflow_deployment_release(id='id', release_id_or_release_tag='release_id_or_release_tag', )
        asyncio.run(main())
        """
