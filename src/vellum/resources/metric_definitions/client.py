...
class MetricDefinitionsClient:
    ...
    def metric_definition_history_item_retrieve(
        self, id: str, history_id_or_release_tag: str, *, request_options: typing.Optional[RequestOptions] = None
        ...
        _response = self._raw_client.metric_definition_history_item_retrieve(
            id, history_id_or_release_tag, request_options=request_options
        )
        return _response.data
...
class AsyncMetricDefinitionsClient:
    ...
    async def execute_metric_definition(
        ...
        *,
        ...
        from vellum import AsyncVellum, MetricDefinitionInput_String
