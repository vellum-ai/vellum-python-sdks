...
class AsyncMetricDefinitionsClient:
    ...
    async def execute_metric_definition(
        ...
        *,
        ...
        async def main() -> None:
            await client.metric_definitions.execute_metric_definition(id='id', inputs=[StringInput(name='name', value='value', )], )
        asyncio.run(main())
        """
    ...
    async def metric_definition_history_item_retrieve(
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.metric_definitions.metric_definition_history_item_retrieve(history_id_or_release_tag='history_id_or_release_tag', id='id', )
        asyncio.run(main())
        """
