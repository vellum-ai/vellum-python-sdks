...
class DocumentIndexesClient:
    ...
    def add_document(
        self, id: str, document_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> None:
        """
        ...
        """
        _response = self._raw_client.add_document(id, document_id, request_options=request_options)
        return _response.data
    ...
    def remove_document(
        ...
        """
        _response = self._raw_client.remove_document(id, document_id, request_options=request_options)
        return _response.data
...
class AsyncDocumentIndexesClient:
    ...
    async def add_document(
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.add_document(id, document_id, request_options=request_options)
        return _response.data
    ...
    async def remove_document(
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.remove_document(id, document_id, request_options=request_options)
        return _response.data
