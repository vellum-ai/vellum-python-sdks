...
class AsyncDocumentIndexesClient:
    ...
    async def create(
        ...
        *,
        ...
        client = AsyncVellum(api_version="YOUR_API_VERSION", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.document_indexes.create(label='x', name='x', indexing_config=DocumentIndexIndexingConfigRequest(vectorizer=OpenAiVectorizerTextEmbedding3SmallRequest(config=OpenAiVectorizerConfigRequest(), ), ), )
        asyncio.run(main())
        """
    ...
    async def update(
        ...
        *,
        ...
        client = AsyncVellum(api_version="YOUR_API_VERSION", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.document_indexes.update(id='id', label='x', )
        asyncio.run(main())
        """
