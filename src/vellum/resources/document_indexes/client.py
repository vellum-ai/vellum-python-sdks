...
class DocumentIndexesClient:
    ...
    def create(
        ...
        *,
        ...
        client = Vellum(api_key="YOUR_API_KEY", )
        client.document_indexes.create(label='My Document Index', name='my-document-index', indexing_config=DocumentIndexIndexingConfigRequest(vectorizer=HkunlpInstructorXlVectorizerRequest(config=InstructorVectorizerConfigRequest(instruction_domain='', instruction_query_text_type='plain_text', instruction_document_text_type='plain_text', ), ), chunking=SentenceChunkingRequest(chunker_config=SentenceChunkerConfigRequest(character_limit=1000, min_overlap_ratio=0.5, ), ), ), )
        """
...
class AsyncDocumentIndexesClient:
    ...
    async def create(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.document_indexes.create(label='My Document Index', name='my-document-index', indexing_config=DocumentIndexIndexingConfigRequest(vectorizer=HkunlpInstructorXlVectorizerRequest(config=InstructorVectorizerConfigRequest(instruction_domain='', instruction_query_text_type='plain_text', instruction_document_text_type='plain_text', ), ), chunking=SentenceChunkingRequest(chunker_config=SentenceChunkerConfigRequest(character_limit=1000, min_overlap_ratio=0.5, ), ), ), )
        asyncio.run(main())
        """
    ...
    async def retrieve(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> DocumentIndexRead:
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.document_indexes.retrieve(id='id', )
        asyncio.run(main())
        """
    ...
    async def update(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.document_indexes.update(id='id', label='label', )
        asyncio.run(main())
        """
    ...
    async def destroy(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.document_indexes.destroy(id='id', )
        asyncio.run(main())
        """
    ...
    async def partial_update(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.document_indexes.partial_update(id='id', )
        asyncio.run(main())
        """
    ...
    async def add_document(
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.document_indexes.add_document(document_id='document_id', id='id', )
        asyncio.run(main())
        """
    ...
    async def remove_document(
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.document_indexes.remove_document(document_id='document_id', id='id', )
        asyncio.run(main())
        """
