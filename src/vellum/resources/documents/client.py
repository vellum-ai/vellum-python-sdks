    ...
    def partial_update(
        ...
        *,
        ...
        _response = self._raw_client.partial_update(
            id, label=label, status=status, metadata=metadata, request_options=request_options
        )
        return _response.data
...
class AsyncDocumentsClient:
    ...
    async def retrieve(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> DocumentRead:
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.documents.retrieve(id='id', )
        asyncio.run(main())
        """
    ...
    async def destroy(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.documents.destroy(id='id', )
        asyncio.run(main())
        """
    ...
    async def partial_update(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.documents.partial_update(id='id', )
        asyncio.run(main())
        """
    ...
    async def upload(
        ...
        **Note:** Uses a base url of `https://documents.vellum.ai`.
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.documents.upload(label='label', )
        asyncio.run(main())
        """
