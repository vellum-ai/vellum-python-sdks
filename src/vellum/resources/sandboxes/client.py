...
class SandboxesClient:
    ...
    def upsert_sandbox_scenario(
        ...
        *,
        ...
        client = Vellum(api_key="YOUR_API_KEY", )
        client.sandboxes.upsert_sandbox_scenario(id='id', label='Scenario 1', inputs=[NamedScenarioInputStringVariableValueRequest(value='Hello, world!', name='var_1', ), NamedScenarioInputStringVariableValueRequest(value='Why hello, there!', name='var_2', )], )
        """
...
class AsyncSandboxesClient:
    ...
    async def deploy_prompt(
        ...
        *,
        ...
        async def main() -> None:
            await client.sandboxes.deploy_prompt(id='id', prompt_variant_id='prompt_variant_id', )
        asyncio.run(main())
        """
    ...
    async def upsert_sandbox_scenario(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.sandboxes.upsert_sandbox_scenario(id='id', label='Scenario 1', inputs=[NamedScenarioInputStringVariableValueRequest(value='Hello, world!', name='var_1', ), NamedScenarioInputStringVariableValueRequest(value='Why hello, there!', name='var_2', )], )
        asyncio.run(main())
        """
    ...
    async def delete_sandbox_scenario(
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.sandboxes.delete_sandbox_scenario(id='id', scenario_id='scenario_id', )
        asyncio.run(main())
        """
