...
class AsyncTestSuitesClient:
    ...
    async def list_test_suite_test_cases(
        ...
        *,
        ...
        async def main() -> None:
            await client.test_suites.list_test_suite_test_cases(id='id', )
        asyncio.run(main())
        """
    ...
    async def upsert_test_suite_test_case(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.test_suites.upsert_test_suite_test_case(id_='id', label='Test Case 1', input_values=[NamedTestCaseStringVariableValueRequest(value='What are your favorite colors?', name='var_1', )], evaluation_values=[NamedTestCaseArrayVariableValueRequest(value=[StringVellumValueRequest(value='Red', ), StringVellumValueRequest(value='Green', ), StringVellumValueRequest(value='Blue', )], name='var_2', )], )
        asyncio.run(main())
        """
    ...
    async def test_suite_test_cases_bulk(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            response = await client.test_suites.test_suite_test_cases_bulk(id='id', request=[TestSuiteTestCaseCreateBulkOperationRequest(id='id', data=CreateTestSuiteTestCaseRequest(input_values=[NamedTestCaseStringVariableValueRequest(name='name', )], evaluation_values=[NamedTestCaseStringVariableValueRequest(name='name', )], ), )], )
    ...
    async def delete_test_suite_test_case(
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.test_suites.delete_test_suite_test_case(id='id', test_case_id='test_case_id', )
        asyncio.run(main())
        """
