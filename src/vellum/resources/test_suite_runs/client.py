...
class AsyncTestSuiteRunsClient:
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.test_suite_runs.create(exec_config=TestSuiteRunDeploymentReleaseTagExecConfigRequest(data=TestSuiteRunDeploymentReleaseTagExecConfigDataRequest(deployment_id='deployment_id', ), ), )
        asyncio.run(main())
        """
    ...
    async def retrieve(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> TestSuiteRunRead:
        ...
        client = AsyncVellum(api_version="YOUR_API_VERSION", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.test_suite_runs.retrieve(id='id', )
        asyncio.run(main())
        """
    ...
    async def list_executions(
        ...
        *,
        ...
        client = AsyncVellum(api_version="YOUR_API_VERSION", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.test_suite_runs.list_executions(id='id', )
        asyncio.run(main())
        """
