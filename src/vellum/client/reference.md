...
<details><summary><code>client.workflow_deployments.<a href="src/vellum/resources/workflow_deployments/client.py">workflow_deployment_execute_stream</a>(...)</code></summary>
<dl>
<dd>
...
response = client.workflow_deployments.workflow_deployment_execute_stream(
    id="id",
    inputs=[
        WorkflowRequestStringInputRequest(
            name="x",
...
**trigger:** `typing.Optional[str]` — The name or ID of a workflow trigger to use for this execution.
