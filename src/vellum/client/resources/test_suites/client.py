...
class AsyncTestSuitesClient:
    ...
    async def upsert_test_suite_test_case(
        ...
        *,
        ...
        client = AsyncVellum(api_version="YOUR_API_VERSION", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.test_suites.upsert_test_suite_test_case(id_='id', input_values=[NamedTestCaseStringVariableValueRequest(name='x', ), NamedTestCaseStringVariableValueRequest(name='x', )], evaluation_values=[NamedTestCaseStringVariableValueRequest(name='x', ), NamedTestCaseStringVariableValueRequest(name='x', )], )
        asyncio.run(main())
        """
    ...
    async def test_suite_test_cases_bulk(
        ...
        *,
        ...
        client = AsyncVellum(api_version="YOUR_API_VERSION", api_key="YOUR_API_KEY", )
        async def main() -> None:
            response = await client.test_suites.test_suite_test_cases_bulk(id='id', request=[TestSuiteTestCaseCreateBulkOperationRequest(id='id', data=CreateTestSuiteTestCaseRequest(input_values=[NamedTestCaseStringVariableValueRequest(name='x', ), NamedTestCaseStringVariableValueRequest(name='x', )], evaluation_values=[NamedTestCaseStringVariableValueRequest(name='x', ), NamedTestCaseStringVariableValueRequest(name='x', )], ), ), TestSuiteTestCaseCreateBulkOperationRequest(id='id', data=CreateTestSuiteTestCaseRequest(input_values=[NamedTestCaseStringVariableValueRequest(name='x', ), NamedTestCaseStringVariableValueRequest(name='x', )], evaluation_values=[NamedTestCaseStringVariableValueRequest(name='x', ), NamedTestCaseStringVariableValueRequest(name='x', )], ), )], )
