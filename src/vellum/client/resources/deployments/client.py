...
class AsyncDeploymentsClient:
    ...
    async def retrieve(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> DeploymentRead:
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.deployments.retrieve(id='id', )
        asyncio.run(main())
        """
    ...
    async def deployment_history_item_retrieve(
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.deployments.deployment_history_item_retrieve(history_id_or_release_tag='history_id_or_release_tag', id='id', )
        asyncio.run(main())
        """
    ...
    async def list_deployment_release_tags(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.deployments.list_deployment_release_tags(id='id', )
        asyncio.run(main())
        """
    ...
    async def retrieve_deployment_release_tag(
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.deployments.retrieve_deployment_release_tag(id='id', name='name', )
        asyncio.run(main())
        """
    ...
    async def update_deployment_release_tag(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.deployments.update_deployment_release_tag(id='id', name='name', )
        asyncio.run(main())
        """
    ...
    async def retrieve_prompt_deployment_release(
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.deployments.retrieve_prompt_deployment_release(id='id', release_id_or_release_tag='release_id_or_release_tag', )
        asyncio.run(main())
        """
    ...
    async def retrieve_provider_payload(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.deployments.retrieve_provider_payload(inputs=[StringInputRequest(name='name', value='value', )], )
        asyncio.run(main())
        """
