...
class AsyncPromptsClient:
    ...
    async def pull(
        ...
        *,
        ...
        async def main() -> None:
            await client.prompts.pull(id='id', )
        asyncio.run(main())
        """
    ...
    async def push(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.prompts.push(exec_config=PromptExecConfig(ml_model='ml_model', input_variables=[VellumVariable(id='id', key='key', type="STRING", )], parameters=PromptParameters(), blocks=[JinjaPromptBlock(template='template', )], ), )
        asyncio.run(main())
        """
