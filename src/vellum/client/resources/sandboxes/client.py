...
class AsyncSandboxesClient:
    ...
    async def upsert_sandbox_scenario(
        ...
        *,
        ...
        client = AsyncVellum(api_version="YOUR_API_VERSION", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.sandboxes.upsert_sandbox_scenario(id='id', inputs=[NamedScenarioInputStringVariableValueRequest(name='x', ), NamedScenarioInputStringVariableValueRequest(name='x', )], )
        asyncio.run(main())
        """
