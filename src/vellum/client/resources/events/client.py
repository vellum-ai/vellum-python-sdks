...
class EventsClient:
    ...
    def monitoring_v_1_events_create(
        ...
        """
        _response = self._raw_client.monitoring_v_1_events_create(request=request, request_options=request_options)
...
class AsyncEventsClient:
    ...
    async def monitoring_v_1_events_create(
        self, *, request: WorkflowEvent, request_options: typing.Optional[RequestOptions] = None
    ) -> EventCreateResponse:
        """
        Accept an event and publish it to ClickHouse for analytics processing.
        ...
        async def main() -> None:
            await client.events.monitoring_v_1_events_create(
                request=NodeExecutionInitiatedEvent(
                    body=NodeExecutionInitiatedBody(
                        node_definition=VellumCodeResourceDefinition(
                            name="name",
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.monitoring_v_1_events_create(
