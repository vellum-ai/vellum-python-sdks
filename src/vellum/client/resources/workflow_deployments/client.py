...
from .types.execute_workflow_deployment_stream_request_inputs import ExecuteWorkflowDeploymentStreamRequestInputs
...
class WorkflowDeploymentsClient:
    ...
    def workflow_deployment_execute_stream(
        self,
        id: str,
        *,
        ...
        for chunk in response:
            yield chunk
        """
        with self._raw_client.workflow_deployment_execute_stream(
            id, inputs=inputs, trigger=trigger, request_options=request_options
        ) as r:
            yield from r.data
...
class AsyncWorkflowDeploymentsClient:
    ...
    async def workflow_deployment_execute_stream(
        self,
        id: str,
        *,
        inputs: ExecuteWorkflowDeploymentStreamRequestInputs,
        ...
        async def main() -> None:
            response = (
                await client.workflow_deployments.workflow_deployment_execute_stream(
                    id="id",
                    inputs=[
                        WorkflowRequestStringInputRequest(
                            name="x",
        ...
        asyncio.run(main())
        """
        async with self._raw_client.workflow_deployment_execute_stream(
            id, inputs=inputs, trigger=trigger, request_options=request_options
        ) as r:
