...
from .resources.release_reviews.client import AsyncReleaseReviewsClient, ReleaseReviewsClient
...
class AsyncVellum:
    ...
    async def execute_api(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.execute_api(url='url', )
        asyncio.run(main())
        """
    ...
    async def execute_code(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.execute_code(code='code', runtime="PYTHON_3_11_6", input_values=[StringInput(name='name', value='value', )], packages=[CodeExecutionPackage(version='version', name='name', )], output_type="STRING", )
        asyncio.run(main())
        """
    ...
    async def execute_prompt_stream(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            response = await client.execute_prompt_stream(inputs=[StringInputRequest(name='name', value='value', )], )
    ...
    async def execute_workflow(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.execute_workflow(inputs=[WorkflowRequestStringInputRequest(name='name', value='value', )], )
        asyncio.run(main())
        """
    ...
    async def execute_workflow_stream(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            response = await client.execute_workflow_stream(inputs=[WorkflowRequestStringInputRequest(name='name', value='value', )], )
            async for chunk in response:
                yield chunk
        asyncio.run(main())
        """
    ...
    async def generate(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.generate(requests=[GenerateRequest(input_values={'key': 'value'
            }, )], )
        asyncio.run(main())
        """
    ...
    async def generate_stream(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            response = await client.generate_stream(requests=[GenerateRequest(input_values={'key': 'value'
            }, )], )
            async for chunk in response:
                yield chunk
        asyncio.run(main())
    ...
    async def submit_completion_actuals(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.submit_completion_actuals(actuals=[SubmitCompletionActualRequest()], )
        asyncio.run(main())
        """
    ...
    async def submit_workflow_execution_actuals(
        ...
        *,
        ...
        client = AsyncVellum(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.submit_workflow_execution_actuals(actuals=[WorkflowExecutionActualStringRequest()], )
        asyncio.run(main())
        """
