...
class VellumWorkflowExecutionEvent_WorkflowExecutionInitiated(UniversalBaseModel):
...
class VellumWorkflowExecutionEvent_WorkflowExecutionStreaming(UniversalBaseModel):
...
class VellumWorkflowExecutionEvent_WorkflowExecutionFulfilled(UniversalBaseModel):
...
class VellumWorkflowExecutionEvent_WorkflowExecutionRejected(UniversalBaseModel):
...
class VellumWorkflowExecutionEvent_WorkflowExecutionPaused(UniversalBaseModel):
...
class VellumWorkflowExecutionEvent_WorkflowExecutionResumed(UniversalBaseModel):
...
class VellumWorkflowExecutionEvent_WorkflowExecutionSnapshotted(UniversalBaseModel):
...
update_forward_refs(VellumWorkflowExecutionEvent_WorkflowExecutionInitiated)
update_forward_refs(VellumWorkflowExecutionEvent_WorkflowExecutionStreaming)
update_forward_refs(VellumWorkflowExecutionEvent_WorkflowExecutionFulfilled)
update_forward_refs(VellumWorkflowExecutionEvent_WorkflowExecutionRejected)
update_forward_refs(VellumWorkflowExecutionEvent_WorkflowExecutionPaused)
update_forward_refs(VellumWorkflowExecutionEvent_WorkflowExecutionResumed)
update_forward_refs(VellumWorkflowExecutionEvent_WorkflowExecutionSnapshotted)
