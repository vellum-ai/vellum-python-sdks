...
class ChatMessageContent_String(UniversalBaseModel):
...
class ChatMessageContent_FunctionCall(UniversalBaseModel):
...
class ChatMessageContent_Array(UniversalBaseModel):
...
class ChatMessageContent_Audio(UniversalBaseModel):
...
class ChatMessageContent_Video(UniversalBaseModel):
...
class ChatMessageContent_Image(UniversalBaseModel):
...
class ChatMessageContent_Document(UniversalBaseModel):
