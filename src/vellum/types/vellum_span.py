...
class VellumSpan_WorkflowExecution(UniversalBaseModel):
...
class VellumSpan_NodeExecution(UniversalBaseModel):
...
VellumSpan = typing.Union[VellumSpan_WorkflowExecution, VellumSpan_NodeExecution]
update_forward_refs(VellumSpan_WorkflowExecution)
update_forward_refs(VellumSpan_NodeExecution)
