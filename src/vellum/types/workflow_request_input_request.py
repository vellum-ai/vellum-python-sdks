...
class WorkflowRequestInputRequest_String(UniversalBaseModel):
...
class WorkflowRequestInputRequest_Json(UniversalBaseModel):
...
class WorkflowRequestInputRequest_ChatHistory(UniversalBaseModel):
...
class WorkflowRequestInputRequest_Number(UniversalBaseModel):
...
class WorkflowRequestInputRequest_Audio(UniversalBaseModel):
...
class WorkflowRequestInputRequest_Video(UniversalBaseModel):
...
class WorkflowRequestInputRequest_Image(UniversalBaseModel):
...
class WorkflowRequestInputRequest_Document(UniversalBaseModel):
