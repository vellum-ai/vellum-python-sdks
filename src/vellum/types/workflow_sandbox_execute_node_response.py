...
class WorkflowSandboxExecuteNodeResponse_NodeExecutionFulfilled(UniversalBaseModel):
...
class WorkflowSandboxExecuteNodeResponse_NodeExecutionRejected(UniversalBaseModel):
...
WorkflowSandboxExecuteNodeResponse = typing.Union[
    WorkflowSandboxExecuteNodeResponse_NodeExecutionFulfilled, WorkflowSandboxExecuteNodeResponse_NodeExecutionRejected
]
update_forward_refs(WorkflowSandboxExecuteNodeResponse_NodeExecutionFulfilled)
update_forward_refs(WorkflowSandboxExecuteNodeResponse_NodeExecutionRejected)
