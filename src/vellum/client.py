...
class Vellum:
    ...
    workspace_api_key : typing.Optional[str]
    environment_api_key : typing.Optional[str]
    ...
    def __init__(
        ...
        *,
        ...
        workspace_api_key: typing.Optional[str] = os.getenv("VELLUM_API_KEY"),
        environment_api_key: typing.Optional[str] = os.getenv("VELLUM_API_KEY"),
        ...
        if workspace_api_key is None:
            raise ApiError(
                body="The client must be instantiated be either passing in workspace_api_key or setting VELLUM_API_KEY"
            )
