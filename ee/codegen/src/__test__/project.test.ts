...
`,
  ...
  describe("combinator normalization", () => {
    ...
    it("should handle a workflow with mixed combinators", async () => {
      // Given a workflow with a node that has an OR combinator and another node that has an AND combinator
      const displayData = {
        workflow_raw_data: {
          edges: [
            {
