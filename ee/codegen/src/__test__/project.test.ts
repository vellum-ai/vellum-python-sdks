...
`,
  ...
  describe("port", () => {
    it("should generate correct port references", async () => {
      const displayData = {
        workflow_raw_data: {
          edges: [
            {
              ...
              source_handle_id: "entry-point-source-handle",
              target_handle_id: "inline-prompt-node-target-handle",
            },
            {
              id: "edge-2",
              type: "DEFAULT",
              source_node_id: "inline-prompt-node",
              target_node_id: "final-output-node",
              source_handle_id: "inline-prompt-node-if-port",
              target_handle_id: "final-target-node-target-handle",
            },
            {
              id: "edge-3",
              type: "DEFAULT",
              source_node_id: "inline-prompt-node",
              target_node_id: "api-node",
              source_handle_id: "inline-prompt-node-else-port",
              target_handle_id: "api-node-target-handle",
            },
            {
              id: "edge-4",
              type: "DEFAULT",
              ...
              source_handle_id: "api-node-source-handle",
              target_handle_id: "code-execution-node-target-handle",
            },
            {
              id: "edge-5",
              type: "DEFAULT",
              ...
              target_node_id: "inline-prompt-node",
              source_handle_id: "code-execution-node-port",
              target_handle_id: "inline-prompt-node-target-handle",
            },
          ],
          nodes: [
            {
              ...
              data: {
                ...
                filepath: null,
                packages: [],
                output_id: "5d81be90-b1ac-424e-ae02-12ba95221513",
                output_type: "CHAT_HISTORY",
                code_input_id: "e4ac7bc6-4fe6-4476-9e72-566627a6a7b6",
                log_output_id: "71c6d512-6f39-402e-b3e0-592c0995fec2",
                error_output_id: null,
                runtime_input_id: "ab1e8df8-83f6-47a0-813e-99cc77096654",
                source_handle_id: "code-execution-node-port",
                target_handle_id: "code-execution-node-target-handle",
              },
              type: "CODE_EXECUTION",
              ...
              inputs: [
                {
                  id: "e4ac7bc6-4fe6-4476-9e72-566627a6a7b6",
                  key: "code",
                  value: {
                    rules: [
                      {
            ...
            },
            {
              ...
              data: {
                label: "API Node",
                url_input_id: "c0b60b3f-92ab-48b1-9f27-30c4866d1c54",
                body_input_id: "039bc573-9806-4063-9781-a907a60ad4e3",
                json_output_id: "5a9c9294-3d78-4885-9fd4-0a12e6a8a84a",
                text_output_id: "6fcaa4e4-7cb3-4f9d-b215-7abaf34ecfb4",
                error_output_id: null,
                method_input_id: "8d4e68ce-aba4-4227-900b-dcd3db977444",
                source_handle_id: "api-node-source-handle",
                target_handle_id: "api-node-target-handle",
                additional_headers: [],
                status_code_output_id: "cbd1c8b0-3edd-436f-b9c3-ff27cbade290",
                api_key_header_key_input_id:
                  "c8bafc11-f2d4-46ca-828f-fd687fec8c3f",
                authorization_type_input_id:
                  "95c88cc7-6be1-44a4-b549-8e7e0bd263c7",
                bearer_token_value_input_id:
                  "e215300a-8b9a-44cf-8325-c32593aa5243",
                api_key_header_value_input_id:
                  "ad50019f-0606-44c6-9d25-d80e14b1487e",
              },
              type: "API",
              ports: [
                {
                  id: "api-node-source-handle",
                  name: "default",
                  type: "DEFAULT",
                },
              ],
            ...
            },
            {
              ...
              data: {
                label: "Prompt",
                variant: "INLINE",
                output_id: "d248e38a-cfbb-4779-a0ba-e261df8fb716",
                exec_config: {
                  settings: {},
                  parameters: {},
                  input_variables: [],
                ...
                ml_model_name: "gpt-4o-mini",
                array_output_id: "9786df86-634f-4b62-bff0-ff5633bdb4d9",
                error_output_id: null,
                source_handle_id: "inline-prompt-node-if-port",
                target_handle_id: "inline-prompt-node-target-handle",
              },
              ...
              ports: [
                  ...
                  expression: {
                    lhs: {
                      lhs: {
                        lhs: {
                          type: "NODE_OUTPUT",
                          node_id: "inline-prompt-node",
                          node_output_id:
                            "9786df86-634f-4b62-bff0-ff5633bdb4d9",
                        },
                        rhs: {
                          type: "CONSTANT_VALUE",
                ...
                {
                  id: "inline-prompt-node-else-port",
            ...
            },
            {
              ...
              data: {
                name: "final-output",
                label: "Final Output",
                output_id: "f583931f-0819-4458-8bef-dd32eed5596f",
                output_type: "STRING",
                node_input_id: "d9363aad-c3ad-4323-8444-6ca3ec2b88b1",
                target_handle_id: "final-target-node-target-handle",
              },
              type: "TERMINAL",
              inputs: [],
