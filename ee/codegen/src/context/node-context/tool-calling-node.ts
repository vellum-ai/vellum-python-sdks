...
import {
  NodePort,
  ToolCallingNode as ToolCallingNodeType,
} from "src/types/vellum";

export class ToolCallingNodeContext extends BaseNodeContext<ToolCallingNodeType> {
  baseNodeClassName = "ToolCallingNode";
