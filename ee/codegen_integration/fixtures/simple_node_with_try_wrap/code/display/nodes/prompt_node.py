...
class PromptNodeDisplay(BaseInlinePromptNodeDisplay[PromptNode.__wrapped_node__]):
    label = "Prompt"
    ...
    output_display = {
        PromptNode.__wrapped_node__.Outputs.text: NodeOutputDisplay(
            id=UUID("13e677d3-14e7-4b0c-ab36-834bb99c930c"), name="text"
        ),
        PromptNode.__wrapped_node__.Outputs.results: NodeOutputDisplay(
            id=UUID("01976625-90e7-4ecb-b752-454b2cd0bb67"), name="results"
        ),
    }
    port_displays = {
        PromptNode.__wrapped_node__.Ports.default: PortDisplayOverrides(id=UUID("4e8bdb06-2adb-474f-9bd7-f6ee01fd4c2b"))
    }
