...
class WorkflowDisplay(VellumWorkflowDisplay[Workflow]):
    ...
    inputs_display = {
        Inputs.chat_history: WorkflowInputsVellumDisplayOverrides(
            id=UUID("d4663e15-8871-42d8-8ef7-59baff2cd436"), name="chat_history", required=False
        )
    }
    entrypoint_displays = {
    ...
    edge_displays = {
        (MostRecentMessage.Ports.default, PromptNode): EdgeDisplay(id=UUID("7ad283cf-0316-48f0-bc39-10ab3623ec7f")),
        (PromptNode.Ports.default, TemplatingNode): EdgeDisplay(id=UUID("196807e4-b1f7-4286-b02b-5caf837f0362")),
        (TemplatingNode.Ports.default, ConditionalNode): EdgeDisplay(id=UUID("293a13ac-89c5-4fc6-a142-dd9a5e36d730")),
        ...
        (ConditionalNode.Ports.branch_2, PromptNode16): EdgeDisplay(id=UUID("a90e7c00-ee9a-41d4-8339-f4bdd6b747b8")),
        (PromptNode16.Ports.default, TemplatingNode15): EdgeDisplay(id=UUID("094fccc2-855c-456e-a1db-0df57cd583c1")),
        (TemplatingNode15.Ports.default, APINode): EdgeDisplay(id=UUID("02b212d8-d6cc-4e02-99ea-dce5716cb73b")),
        (APINode.Ports.default, PromptNode18): EdgeDisplay(id=UUID("1e4489fd-62ee-4b2d-8abb-b3082485ef01")),
        (ConditionalNode.Ports.branch_4, PromptNode19): EdgeDisplay(id=UUID("a5d7013a-4ecb-4f35-8230-ef8fbfecda27")),
        (ConditionalNode.Ports.branch_1, SubworkflowNode): EdgeDisplay(id=UUID("7e517fcd-b174-435f-b429-39a5230571b8")),
        (SubworkflowNode.Ports.default, PromptNode14): EdgeDisplay(id=UUID("84229185-fb0e-4f7f-bd11-1de423396872")),
        (PromptNode19.Ports.default, FinalOutput2): EdgeDisplay(id=UUID("f88c3cad-c845-41af-abe6-118e0606ac16")),
        (PromptNode18.Ports.default, FinalOutput2): EdgeDisplay(id=UUID("87051c37-8d28-4849-9c09-e6d243b744b6")),
        (PromptNode9.Ports.default, FinalOutput2): EdgeDisplay(id=UUID("9e19ee9e-24a6-47e7-8b10-44781a53018f")),
        (PromptNode14.Ports.default, FinalOutput2): EdgeDisplay(id=UUID("417f05e4-f73a-4d93-98ab-ada609062d38")),
    }
    output_displays = {
