...
class PromptNode14Display(BaseInlinePromptNodeDisplay[PromptNode14]):
    ...
    attribute_ids_by_name = {
        ...
        "parameters": UUID("2236093c-ea33-404e-b218-79d7852d508d"),
    }
    output_display = {
    ...
    display_data = NodeDisplayData(position=NodeDisplayPosition(x=4524, y=631), width=480, height=168, z_index=None)
