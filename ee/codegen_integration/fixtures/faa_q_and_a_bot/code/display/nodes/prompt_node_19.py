...
class PromptNode19Display(BaseInlinePromptNodeDisplay[PromptNode19]):
    ...
    attribute_ids_by_name = {
        ...
        "parameters": UUID("899c301a-c6db-4fc6-acfe-f3011277bcbd"),
    }
    output_display = {
    ...
    display_data = NodeDisplayData(
        position=NodeDisplayPosition(x=3165.684879595973, y=768.6879108547903), z_index=None, width=480, height=170
    )
