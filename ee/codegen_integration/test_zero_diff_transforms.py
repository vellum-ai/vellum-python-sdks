...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            frozenset(
                {
                    # Root __init__.py imports display which we don't check in
                    "__init__.py",
                    # Display files are generated by codegen but not checked into the test module
                    "display/nodes/context_aware_tool_node/__init__.py",
                    "display/workflow.py",
