...
def test_serialize_workflow(vellum_client):
    ...
    assert not DeepDiff(
        [
            {"id": "209488d7-7743-4af2-84df-1fe276f6047f", "key": "json", "type": "JSON"},
            {"id": "f2cf94f1-8eaa-4b56-af48-f58b2ef09181", "key": "headers", "type": "JSON"},
            {"id": "a1c09002-5693-4c6d-8df2-63e1c7148fa6", "key": "status_code", "type": "NUMBER"},
        ],
        output_variables,
        ignore_order=True,
    )
        ...
        [
            {
                ...
                "data": {
                    ...
                    "output_id": "209488d7-7743-4af2-84df-1fe276f6047f",
                    "output_type": "JSON",
            ...
            },
            {
                ...
                "data": {
                    ...
                    "output_id": "f2cf94f1-8eaa-4b56-af48-f58b2ef09181",
                    "output_type": "JSON",
            ...
            },
            {
                ...
                "data": {
                    ...
                    "output_id": "a1c09002-5693-4c6d-8df2-63e1c7148fa6",
                    "output_type": "NUMBER",
