...
class WorkflowDisplay(VellumWorkflowDisplay[Workflow]):
    workflow_display = WorkflowMetaDisplay(
        ...
        display_data=WorkflowDisplayData(
            viewport=WorkflowDisplayDataViewport(x=229.92828392120487, y=109.02906066948549, zoom=0.4254049094147727)
        ),
    )
    inputs_display = {
        Inputs.image_url: WorkflowInputsVellumDisplayOverrides(
            id=UUID("5be00b19-5016-4e16-93b3-980a6f8838ad"), name="image_url", required=True
        ),
        Inputs.workflow_input_chat_history: WorkflowInputsVellumDisplayOverrides(
            id=UUID("ae1eb3ce-4b1d-40ee-936f-308f1062a4fd"),
