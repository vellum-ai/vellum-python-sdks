...
class ExtractByChatHistoryDisplay(BaseInlinePromptNodeDisplay[ExtractByChatHistory]):
    ...
    node_input_ids_by_name = {"prompt_inputs.chat_history": UUID("7c67425d-da0a-4a0b-ae99-0284fa9ee92f")}
    attribute_ids_by_name = {"ml_model": UUID("4dbd5540-ddcd-4db5-a8f0-95639efee626")}
    output_display = {
    ...
    display_data = NodeDisplayData(
        position=NodeDisplayPosition(x=287.169358764978, y=-248.98570613885954),
        width=553,
        height=677,
