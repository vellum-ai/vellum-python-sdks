...
@BaseTryNodeDisplay.wrap(node_id=UUID("39d4d8a9-61c3-49cf-9fb4-0f8c2814a981"))
class DataExtractorDisplay(BaseInlinePromptNodeDisplay[DataExtractor]):
    ...
    node_input_ids_by_name = {"prompt_inputs.chat_history": UUID("462722d6-8acd-4446-b744-28631516e3ee")}
    attribute_ids_by_name = {"ml_model": UUID("27f30854-59fe-4c87-aaa0-7721caafbf99")}
    output_display = {
    ...
    display_data = NodeDisplayData(
        position=NodeDisplayPosition(x=857.2886057113042, y=-157.99381186416284), width=554, height=531
    )
