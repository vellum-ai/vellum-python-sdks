...
class FinalOutput6Display(BaseFinalOutputNodeDisplay[FinalOutput6]):
    ...
    output_id = UUID("4dfe9122-354b-4796-a2de-4eaa38a0c5df")
    output_name = "final-output-6"
    node_input_id = UUID("0a6972dc-ac3a-4d99-9577-be4c4c3dc2a7")
    ...
    display_data = NodeDisplayData(position=NodeDisplayPosition(x=864, y=16.5), width=457, height=239)
