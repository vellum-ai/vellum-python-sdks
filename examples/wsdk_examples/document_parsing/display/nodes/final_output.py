...
class FinalOutputDisplay(BaseFinalOutputNodeDisplay[FinalOutput]):
    ...
    output_id = UUID("9c3830c9-7faa-4872-83e5-7360f662f8e2")
    output_name = "final-output"
    node_input_id = UUID("c84aa0bd-3440-4507-bae4-586dae3b9f22")
    ...
    display_data = NodeDisplayData(
        position=NodeDisplayPosition(x=1465.3578490588761, y=635.1421509411235), width=455, height=239
    )
