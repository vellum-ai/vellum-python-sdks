...
from tests.workflows.run_from_node_uuid import RunFromNodeUuidWorkflow
from tests.workflows.run_from_node_uuid.nodes import Node2
...
def test_run_from_node_with_uuid__invalid_uuid():
    ...
    try:
        ...
        assert "No node found with UUID" in str(e)
        assert str(invalid_uuid) in str(e)
