...
class ToolCallingNodeStreamingToFinalOutputWorkflow(BaseWorkflow[Inputs, BaseState]):
    """
    A workflow that uses ToolCallingNode streaming to FinalOutputNode.
    """

    graph = GetCurrentWeatherNode >> MyFinalOutput
