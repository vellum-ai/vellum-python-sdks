...
from tests.workflows.basic_inline_prompt_node.workflow import (
    BasicInlinePromptWorkflow,
...
def test_non_streaming_workflow__timeout(vellum_adhoc_prompt_client):
    ...
    workflow_rejected_event = events[2]
    ...
    # AND there should be exactly 3 events total
    assert len(events) == 3
